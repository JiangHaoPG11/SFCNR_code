...
class SFT_MRNN_Train_Test():
    def __init__(self, args, data, device):
        ...
        optimizer = torch.optim.Adam([{"params": SFT_MRNN_model.news_encoder.parameters()},
        ...
        optimizer_base = torch.optim.Adam([{"params": SFT_MRNN_model.news_encoder.parameters()},
                                           {"params": SFT_MRNN_model.user_encoder.parameters()},
                                           {"params": SFT_MRNN_model.news_encoder.parameters()},
                                           {"params": SFT_MRNN_model.user_encoder.parameters()},
        ...
        for para in SFT_MRNN_model.named_parameters():
            print(para[0])
        self.trainer = Trainer(args, SFT_MRNN_model, optimizer, optimizer_base, optimizer_Zeroshot_news, optimizer_Zeroshot_user, data)
